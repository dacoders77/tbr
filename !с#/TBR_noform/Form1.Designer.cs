namespace TBR_noform
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(341, 209);
			this.button5.Name = "button5";
			this.button5.Size = new System.Drawing.Size(108, 22);
			this.button5.TabIndex = 57;
			this.button5.Text = "Clear quotes in DB";
			this.button5.UseVisualStyleBackColor = true;
			this.button5.Click += new System.EventHandler(this.button5_Click);
			// 
			// button6
			// 
			this.button6.Location = new System.Drawing.Point(455, 209);
			this.button6.Name = "button6";
			this.button6.Size = new System.Drawing.Size(108, 22);
			this.button6.TabIndex = 58;
			this.button6.Text = "Reset exec basket";
			this.button6.UseVisualStyleBackColor = true;
			this.button6.Click += new System.EventHandler(this.button6_Click);
			// 
			// button7
			// 
			this.button7.Location = new System.Drawing.Point(681, 208);
			this.button7.Name = "button7";
			this.button7.Size = new System.Drawing.Size(108, 22);
			this.button7.TabIndex = 59;
			this.button7.Text = "Aval funds";
